...
pub use mutate::{
    ...
    create_commit, create_commit_only, create_signed_commit, create_signed_commit_amend,
    create_signed_commit_only, create_signed_tag, is_working_tree_dirty, push_follow_tags,
    stage_files, stage_tracked_modified, workdir,
};
pub use query::{
    commit_date, config_value, current_branch, detect_host, head_oid, range_has_commits,
    repo_name_from_remote, resolve_rev, short_status, staged_diff, staged_files, walk_commits,
