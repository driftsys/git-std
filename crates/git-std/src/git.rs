...
pub fn update_cargo_toml_version(
    ...
    // Validate that a [package] section with version exists before rewriting.
    ...
    // Preserve formatting by doing a targeted replacement.
    let updated = standard_version::replace_version_in_toml(&content, new_version)?;
